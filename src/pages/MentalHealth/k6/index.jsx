...
import { Label, FieldSet, RadioOptions } from "react-elements-davis";
    ...
    <FieldSet title={text.k6Test}>
      <div className={styles.listOfQuestions}>
        ...
        <section className={styles.resultBox}>
          <div className="flex w-full items-center justify-start gap-5 rounded pr-2 shadow-md md:mb-6 md:w-1/2 md:pt-[2px]">
            <Label
